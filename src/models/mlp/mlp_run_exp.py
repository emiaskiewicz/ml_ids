...
experiments = [
    {"id": "MLP-01e", "scaling": True, "correlation": False, "feature_selection": False,
     "smote": False, "stage_1": False, "stage_2": False},
    {"id": "MLP-02e", "scaling": True, "correlation": True, "feature_selection": False,
     "smote": False, "stage_1": False, "stage_2": False},
    {"id": "MLP-03e", "scaling": True, "correlation": False, "feature_selection": True,
     "smote": False, "stage_1": False, "stage_2": False},
    {"id": "MLP-04e", "scaling": True, "correlation": True, "feature_selection": True,
     "smote": False, "stage_1": False, "stage_2": False},
    {"id": "MLP-05e", "scaling": True, "correlation": False, "feature_selection": False,
     "smote": True, "stage_1": False, "stage_2": False},
    {"id": "MLP-06e", "scaling": True, "correlation": True, "feature_selection": False,
     "smote": True, "stage_1": False, "stage_2": False},
    {"id": "MLP-07e", "scaling": True, "correlation": False, "feature_selection": True,
     "smote": True, "stage_1": False, "stage_2": False},
    {"id": "MLP-08e", "scaling": True, "correlation": True, "feature_selection": True,
     "smote": True, "stage_1": False, "stage_2": False},
]
