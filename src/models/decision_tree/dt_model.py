...
def save_model(model: DecisionTreeClassifier, config: dict, logger: logging.Logger, preprocessing_artifacts: dict,
...
def main() -> None:
    ...
    X_train, X_val, X_test, y_train, y_val, y_test, preprocessing_artifacts = prepare_dt_data(config)
