...
CONFIG_PATH = PROJECT_DIR / "config" / "cnn.yaml"
SCRIPT_PATH = PROJECT_DIR / "src" / "models" / "cnn" / "cnn_model.py"
DATASET_VARIANT = "easy"
LOG_PATH = PROJECT_DIR / "logs" / "cnn" / DATASET_VARIANT / "runner.log"
STOP_ON_ERROR = True
SKIP_FINISHED = True
EVALUATE_TEST = False
SAVE_PLOTS = False
...
def apply_experiment_settings(config: dict, exp: dict) -> dict:
    ...
    config["output"]["summary_path"] = f"outputs/cnn/{DATASET_VARIANT}/cnn_{DATASET_VARIANT}_results_sum.csv"
