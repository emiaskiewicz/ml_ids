...
CONFIG_PATH = PROJECT_DIR / "config" / "logistic_regression.yaml"
SCRIPT_PATH = PROJECT_DIR / "src" / "models" / "logistic_regression" / "lr_model.py"
DATASET_VARIANT = "easy"
LOG_PATH = PROJECT_DIR / "logs" / "logistic_regression" / DATASET_VARIANT / "runner.log"
STOP_ON_ERROR = True
SKIP_FINISHED = True
SAVE_PLOTS = False
EVALUATE_TEST = False
...
experiments = [
    {"id": "LR-01e", "scaling": False, "correlation": False, "feature_selection": False,
     "smote": False, "stage_1": False, "stage_2": False},
    {"id": "LR-02e", "scaling": True, "correlation": False, "feature_selection": False,
     "smote": False, "stage_1": False, "stage_2": False},
    {"id": "LR-03e", "scaling": False, "correlation": True, "feature_selection": False,
     "smote": False, "stage_1": False, "stage_2": False},
    {"id": "LR-04e", "scaling": True, "correlation": True, "feature_selection": False,
     "smote": False, "stage_1": False, "stage_2": False},
    {"id": "LR-05e", "scaling": True, "correlation": False, "feature_selection": False,
     "smote": True, "stage_1": False, "stage_2": False},
    {"id": "LR-06e", "scaling": True, "correlation": False, "feature_selection": True,
     "smote": False, "stage_1": False, "stage_2": False},
    {"id": "LR-07e", "scaling": True, "correlation": True, "feature_selection": False,
     "smote": True, "stage_1": False, "stage_2": False},
    {"id": "LR-08e", "scaling": False, "correlation": False, "feature_selection": False,
     "smote": True, "stage_1": False, "stage_2": False},
    {"id": "LR-09e", "scaling": False, "correlation": False, "feature_selection": True,
     "smote": False, "stage_1": False, "stage_2": False},
    {"id": "LR-10e", "scaling": False, "correlation": False, "feature_selection": True,
     "smote": True, "stage_1": False, "stage_2": False},
    {"id": "LR-11e", "scaling": False, "correlation": True, "feature_selection": False,
     "smote": True, "stage_1": False, "stage_2": False},
    {"id": "LR-12e", "scaling": False, "correlation": True, "feature_selection": True,
     "smote": False, "stage_1": False, "stage_2": False},
    {"id": "LR-13e", "scaling": False, "correlation": True, "feature_selection": True,
     "smote": True, "stage_1": False, "stage_2": False},
    {"id": "LR-14e", "scaling": True, "correlation": False, "feature_selection": True,
     "smote": True, "stage_1": False, "stage_2": False},
    {"id": "LR-15e", "scaling": True, "correlation": True, "feature_selection": True,
     "smote": False, "stage_1": False, "stage_2": False},
    {"id": "LR-16e", "scaling": True, "correlation": True, "feature_selection": True,
     "smote": True, "stage_1": False, "stage_2": False},
]
