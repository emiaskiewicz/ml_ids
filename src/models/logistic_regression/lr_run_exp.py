...
experiments = [
    {"id": "LR-01e", "scaling": True, "correlation": False, "feature_selection": False,
     "smote": False, "stage_1": False, "stage_2": False},
    {"id": "LR-02e", "scaling": True, "correlation": True, "feature_selection": False,
     "smote": False, "stage_1": False, "stage_2": False},
    {"id": "LR-03e", "scaling": True, "correlation": False, "feature_selection": True,
     "smote": False, "stage_1": False, "stage_2": False},
    {"id": "LR-04e", "scaling": True, "correlation": True, "feature_selection": True,
     "smote": False, "stage_1": False, "stage_2": False},
    {"id": "LR-05e", "scaling": True, "correlation": False, "feature_selection": False,
     "smote": True, "stage_1": False, "stage_2": False},
    {"id": "LR-06e", "scaling": True, "correlation": True, "feature_selection": False,
     "smote": True, "stage_1": False, "stage_2": False},
    {"id": "LR-07e", "scaling": True, "correlation": False, "feature_selection": True,
     "smote": True, "stage_1": False, "stage_2": False},
    {"id": "LR-08e", "scaling": True, "correlation": True, "feature_selection": True,
     "smote": True, "stage_1": False, "stage_2": False},
]
